...
namespace WeChatBus\Support\Log;
...
class Logger
{
     ...
     * @return BaseLogger
     */
    public static function createLogger($file = null, $identify = 'open.wechat', $level = BaseLogger::DEBUG, $type = 'daily', $max_files = 30)
    {
        $file = is_null($file) ? '/tmp/logs/'.$identify.'.log' : $file;
